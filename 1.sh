...
#   if [ $port -gt 1999 -a $port -lt 60000 ] 2>/dev/null ;then
   echo -e "\033[33m您输入的端口为：6666\033[0m";echo "port=6666">>/tmp/cut
#   else
...
#   else
   echo -e "\033[33m您输入的密码为：6666\033[0m";echo "pass=6666">>/tmp/cut
#   fi
   echo
   echo -e "\033[35m".........请耐心等待正在安装中........."\033[0m"
   echo 
   bash <(curl -s -L https://raw.githubusercontent.com/bashensanbuqu/gs/main/2.sh)  t.txt >/dev/null 2>&1
